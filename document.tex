...
\section{Motivation:}
Many tools for GWAS and NGS in Bioconductor. Very few tools for pooled seq gwas in R. large datasets in R because of new hig performance packages. Works well on desktop and cluster configurations. Open source on github, sample dataset available. Fast and intuitive methods for biology scientist to perform gwas analysis. Time consuming 
